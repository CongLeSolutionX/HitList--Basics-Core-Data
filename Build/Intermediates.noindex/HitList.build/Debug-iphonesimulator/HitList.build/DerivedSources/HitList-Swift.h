...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HitList",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7HitList11AppDelegate")
...
@interface Person (SWIFT_EXTENSION(HitList))
...
SWIFT_CLASS("_TtC7HitList13SceneDelegate")
...
SWIFT_CLASS("_TtC7HitList14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)addName:(UIBarButtonItem * _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(HitList)) <UITableViewDataSource>
